...
public class AllEqptAlarmHisAction extends PPTAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		...
		//ArrayList rtnlist = alarmsql.getAllAlarmList(Integer.parseInt(displimit), EqptAlarmSQL.TYPE_HIS);
		ArrayList rtnlist = alarmsql.getAllAlarmList(fr_date, to_date, EqptAlarmSQL.TYPE_HIS);
		
		request.setAttribute("subList", rtnlist);
		request.setAttribute("mon_type", String.valueOf(EqptAlarmSQL.TYPE_HIS));
