 ...
 */
public class StockerLayer extends EquipmentLayer {

    public StockerLayer(EquipmentState state) {
        super(state);
        layoutType = LayoutType.STOCKER;
    }

    public String getReferredValue(String referredName) {
        if ("STOCKER_ID".equals(referredName))
            return getId();
